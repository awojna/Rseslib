...
/**
 * Klasa pytajaca czy uzytkownik chce zapisac projekt przed zamknieciem x-em programu
 * @author Damin Wojcik
 *
 */
public class QAskProgramExit extends JDialog implements ActionListener {
	 ...
	 * 
	 */
	public QAskProgramExit(QMainFrame my_owner) {
		super();
		owner = my_owner;
		initialize();
	}
	...
	private JPanel getJPanel1() {
		if (jPanel1 == null) {
			...
			jClose_label.setText(owner.messages.getString("QAskProgramExit"));
			//jClose_label.setPreferredSize(new Dimension(350, 40));
			jPanel1 = new JPanel();
	...
	private JButton getJYes_Button() {
		if (jYes_Button == null) {
			...
			jYes_Button.setPreferredSize(new Dimension(100, 20));
	...
	private JButton getJNo_Button() {
		if (jNo_Button == null) {
			...
			jNo_Button.setPreferredSize(new Dimension(100, 20));
	...
	private JButton getJResign_Button() {
		if (jResign_Button == null) {
			...
			jResign_Button.setPreferredSize(new Dimension(100, 20));
